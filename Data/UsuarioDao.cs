...
namespace SIPYME.Data
{
    public class UsuarioDao
    {
        ...
        // elimina por el id de la foto
        public static void eliminarFotosProductoByID(int idPy)
        {
            using (MySqlConnection cn = new MySqlConnection(Conection.cn))
            {
        ...
        // elimina por el id de la foto
        public static void eliminarFotosPymeByID(int idPy)
        {
            using (MySqlConnection cn = new MySqlConnection(Conection.cn))
            {
        ...
        public static List<Pyme> listarPymesAprobadas()
        {
            MySqlConnection cn = new MySqlConnection(Conection.cn);
            MySqlCommand cmd = new MySqlCommand();
            MySqlDataReader reader;
            cn.Open();
            cmd.Connection = cn;
            cmd.CommandText = "SELECT * FROM Pyme WHERE estado = 'Aprobada'";
            reader = cmd.ExecuteReader();
            List<Pyme> pymes = new List<Pyme>();
            while (reader.Read())
            {
